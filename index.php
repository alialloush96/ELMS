...
$sql ="SELECT EmailId,Password,Status,id,	FirstName,LastName FROM tblemployees WHERE EmailId=:uname and Password=:password";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
          ...
          <div class="footer">
                    <p class="copyright"><a href="#">FreeIT-Group</a>©</p>
