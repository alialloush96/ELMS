...
<?php
$eid=$_SESSION['eid'];
$sql = "SELECT LeaveType,leaveTime,comeTime,Description,PostingDate,AdminRemarkDate,AdminRemark,Status from tblleaves where empid=:eid";
...
{               ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->leaveTime);?></td>
                                            <td><?php echo htmlentities($result->comeTime);?></td>
