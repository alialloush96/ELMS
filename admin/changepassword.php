...
if($newpassword==$conpassword){
  if($email==""){
    ...
    $con="update admin set Password=:newpassword,email=:email where UserName=:username";
  }
...
<head>
    ...
    <!-- Title -->
    <title>Admin | Change Information</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Change Information</div>
                    </div>
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <input id="email" type="email"  class="validate" autocomplete="off" name="email">
