...
if($stats){
        ...
        <td><?php $roll=$result->roll;
          ...
          <td <?php if($daysPassport<=10){?>style="background:lightcoral;"<?php }?>><?php echo htmlentities($result->Passport_valid);?></td>
          <td <?php if($daysCard<=10){?>style="background:lightcoral;"<?php }?> ><?php echo htmlentities($result->idcard_valid);?></td>
          <td <?php if($daysVisa<=10){?>style="background:lightcoral;"<?php }?>><?php echo htmlentities($result->Visa_valid);?></td>
