                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <?php if($msg){?><div class="succWrap"><strong>SUCCESS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                  ...
                                  <a href="addobject.php"  class="waves-effect waves-light btn indigo m-b-xs pl">ADD Object</a>
                                  </div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT *  from  objects where emp_id='$_SESSION[eid]'";
$query = $dbh -> prepare($sql);
$query->execute();
...
?>
    <tr>
        ...
        <td>
          <a href="editobject.php?obid=<?php echo htmlentities($result->id);?>"><i class="material-icons">mode_edit</i></a>
          <a href="manageobject.php?delid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete this object?');" ><i class="material-icons">delete_forever</i>
       </td>
