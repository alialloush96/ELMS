...
{               ?>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Change Password</a></li>
                    ...
                    <li class="no-padding">
                     ...
                     <li class="no-padding"><a class="waves-effect waves-grey" href="manageobject.php"><i class="material-icons">account_box</i>My Objects</a></li>
                ...
                <div class="footer">
                    <p class="copyright">All Rights Saved &copy<a href="#"> FreeIT-Group </a></p>
